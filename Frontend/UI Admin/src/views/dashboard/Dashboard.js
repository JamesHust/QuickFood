    ...
    <>
      ...
      <CCard>
        <CCardBody>
          <CRow>
            <CCol sm="5">
              <h4 id="traffic" className="card-title mb-0">Danh số bán</h4>
        ...
        <CCardFooter>
          <CRow className="text-center">
            <CCol md sm="12" className="mb-sm-2 mb-0">
              <div className="text-muted">Doanh số bán</div>
              <strong>29.703 Sản phẩm bán (40%)</strong>
              <CProgress
            ...
            <CCol md sm="12" className="mb-sm-2 mb-0 d-md-down-none">
              <div className="text-muted">Lượng nhập</div>
              <strong>24.093 Sản phẩm nhập (20%)</strong>
              <CProgress
                className="progress-xs mt-2"
                precision={1}
                color="info"
            ...
            <CCol md sm="12" className="mb-sm-2 mb-0">
              <div className="text-muted">Số sản phẩm còn</div>
              <strong>123 Sản phẩm (30%)</strong>
              <CProgress
                className="progress-xs mt-2"
                precision={1}
                color="warning"
